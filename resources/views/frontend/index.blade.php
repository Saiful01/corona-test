        ...
        <div class="col-md-6">
            <div class="name">
                <p>স্বাগতম। এই টুলটির সাহায্যে আপনি কোভিড-১৯ বা
                    ...
                    মূল্যায়ন করতে পারবেন। এমনকি আপনার ঝুঁকির মাত্রা ও করনীয় সম্পর্কেও জানতে পারবেন। এই সফটওয়্যারটি বিশ্ব
                    স্বাস্থ্য সংস্থা এর গাইডলাইন মেনে তৈরি করা হয়েছে। তবে কোন অবস্থাতেই এই সফটওয়ার থেকে প্রাপ্ত ফলাফলকে
                    অভিজ্ঞ ডাক্তার কর্তৃক স্বাস্থ্য পরামর্শ হিসেবে বিবেচনা করা যাবে না। সফটওয়ারে আপনার শেয়ার করা তথ্যের
            ...
            <div class="radio">
                <form action="" class="form-inline p-">
                    <input type="radio" name="gender" value="male"> ০-২০
                    <input type="radio" name="gender" value="female"> ২১-৩০
                    <input type="radio" name="gender" value="other"> ৩১-৪০
                    <input type="radio" name="gender" value="other"> ৪১-৫০
                    <input type="radio" name="gender" value="other"> ৫১-৬৫
                    <input type="radio" name="gender" value="other"> ৬৫+
                </form>
            </div>
            ...
            <div class="radio">
                <form action="">
                    ...
                    <input type="radio" name="gender" value="female"> শরীরের তাপমাত্রা স্বাভাবিক আছে 98°F-100.6°F<br>
            ...
            <div class="radio">
                <form>
                    ...
                    <label class="checkbox-inline">
                        <input type="checkbox" value="">অতি দুর্বলতা (যেমনঃ বাথরুমে যেতে অন্যের সাহায্যের প্রয়োজন হয় এমন)
                    </label>
                    <label class="checkbox-inline">
                        <input type="checkbox" value="">সর্দি বা নাক দিয়ে পানি পড়া
                    </label>
                    <label>
                        <a href="" class="btn btn-success">পরবর্তী</a>
                    </label>
                </form>
            </div>
            <div class="name">
            ...
            <div class="radio">
                <form action="">
                    ...
                    <input type="radio" name="gender" value="female"> গত ১৪ দিনের মধ্যে করোনা ভাইরাসে আক্রান্ত ব্যক্তির সংস্পর্শে গিয়েছিলাম
                    <input type="radio" name="gender" value="other"> গত ১৪ দিনের মধ্যে করোনা ভাইরাসে আক্রান্ত এলাকা বা বিদেশে ভ্রমণ করেছি<br>
                    <input type="radio" name="gender" value="other"> গত ১৪ দিনের মধ্যে বিদেশ থেকে ফিরেছে এমন কারো সংস্পর্শে গিয়েছিলাম
                    <input type="radio" name="gender" value="other"> গত ১৪ দিনের মধ্যে জ্বর, কাশি, শ্বাসকষ্ট আছে এমন কারো সংস্পর্শে গিয়েছিলাম (যেমনঃ পরিবার সদস্য / সহকর্মী)
                </form>
            </div>
            <div class="name">
            ...
            <label>
                <a href="/form" class="btn btn-success">পরবর্তী</a>
            </label>
